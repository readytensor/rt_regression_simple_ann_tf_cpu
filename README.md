...
- A **Simple ANN Regression** algorithm using TensorFlow (CPU)
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Simple ANN Regression classifier model implemented in TensorFlow.
